function params = defineSystemParameters(totalTime, dt)
    ...
    params.corticalEigenvalues  = abs(cortexEig.corticalEigenvalues(1:params.numModesC));
    ...
    params.hippoEigenvalues  = abs(hippoEig.hippoEigenvalues(1:params.numModesH));
    ...
    params.nu_seC = 1.65 / 1000;
    params.nu_seH = 1.65 / 100;
