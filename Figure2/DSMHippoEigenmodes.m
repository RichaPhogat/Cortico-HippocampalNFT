...
StartingPoint = floor(length(modeCoeffEtaF(1,:)) / 4);
EndPoint = floor(length(modeCoeffEtaF(1,:))/1);
modeData = modeCoeffEtaF(:, StartingPoint:EndPoint);
nmodes = length(modeCoeffEtaF(:,1));
